...
```{python Linear Regression Model 1 - Python}
...
```{python Model1 Summary Plots - Python}
...
```{python Linear Regression Model 2 - Python}
...
```{python Model2 Summary Plots - Python}
...
```{python Linear Regression Model 3 - Python}
dm = 4 #assumed value of d_min
...
```{python Model3 Summary Plots - Python}
...
```{python Model Comparison - Python, message=FALSE}
plt.scatter(lumber.diameter, lumber.board_ft)
plt.xlabel('Diameter')
plt.ylabel('Board Feet')
