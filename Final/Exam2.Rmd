...
**SUPER IMPORTANT:** Your exam is due by 11:59:59.9999 p.m. Wednesday the 15th as an Rmd file.
...
I have two questions that I am looking for feedback on. Suggestions are appreciated! `r emo::ji("smile")`
  ...
  2. This is the first semester I have offered this course on the T/Th schedule instead of MWF. My motivation was to have longer in class to discuss topics and homework, have group discussions, and work on R/Python code. I am curious to know how you felt about the longer class periods and the oddity (?) of a non-MWF math class.
