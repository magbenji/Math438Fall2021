...
We can see that the algorithms once again agree pretty well. The average number of time steps was around 77 for all iterations, while for the cases where there were outbreaks the average was around ~141 time steps.
